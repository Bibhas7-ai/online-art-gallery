        ...
        <div class="container">
            <div class="left-container">
                <div class="image-container">
                    <img src="https://images.saatchiart.com/saatchi/825562/art/3266145/2336032-HSC00002-7.jpg" alt="Photo" width="600px" height="928px">
                </div>
            </div>
        <div class="right-container">
        <p class="genre-heading">The Pain of Anger</p>
        <p class="author">BY Julie Raworth</p>
        <div class="line"></div>
        <br>
            <div class="description">
                <p>Emphasizes that individuals encompass multiple emotions simultaneously, interlinked in complex ways. </p>
                <br>
                <div class="title-container">
                    <p class="title">Dimensions :</p>&nbsp;<p><u>40.6 W x 50.8 H x 2 D cm</u></p>
                </div>
                <div class="title-container">
                    <p class="title">Period :</p>&nbsp;<p><u>Contemporary Art</u></p>
                </div>
                <div class="title-container">
                    <p class="title">Mediums :</p>&nbsp;<p><u>Acrylic on Canvas</u></p>
                </div>
                <br>  <br>
                <div class="title-container">
                    <p class="title">Offer Price :</p>&nbsp;&nbsp;<p class="price"><u>NPRS 86,000</u></p>
                </div>
            </div>
            <br>
            <div class="offer">
