        ...
        <div class="container">
            <div class="left-container">
                <div class="image-container">
                    <img src="https://www.artmajeur.com/medias/standard/i/g/igor-shaimardanov/artwork/7829821_www.jpg" alt="Photo" width="600px" height="928px">
                </div>
            </div>
        <div class="right-container">
        <p class="genre-heading">Winter Evening</p>
        <p class="author">BY Igor</p>
        <div class="line"></div>
        <br>
            <div class="description">
                <p>Brings to life a tranquil winter landscape, where soft hues blend seamlessly, inviting viewers to immerse themselves into the art.</p>
                <br>
                <div class="title-container">
                    <p class="title">Dimensions :</p>&nbsp;<p><u>30 cm x 40 cm</u></p>
                </div>
                <div class="title-container">
                ...
                <br>  <br>
                <div class="title-container">
                    <p class="title">Offer Price :</p>&nbsp;&nbsp;<p class="price"><u>NPRS 56,000</u></p>
                </div>
            </div>
            <br>
            <div class="offer">
